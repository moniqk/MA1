class levelThree extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("tamanss", 'assets/tamanss.png');
    ...
    create() {
        ...
        this.add.image(0, 0, "tamanss").setOrigin(0, 0).setScale(0.36);
        this.add.image(0, 0, "Level3").setOrigin(0, 0)
